...
In the provided skeleton, you are responsible for developing the method to update the utility table, a function to calculate utility based on the utility table, a metric for determining if your learning algorithm 